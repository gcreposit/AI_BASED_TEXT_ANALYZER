...
# -*- coding: utf-8 -*-
"""
Hindi Text Extractor using OpenAI's GPT-OSS-20B Model

This script extracts structured information from Hindi text using the GPT-OSS-20B model.
...
Usage examples:
    # Analyze direct text
    python hindi_gpt_oss_extractor.py --text "अयोध्या ज़िले में थाना कैंट क्षेत्र में विवाद हुआ..." --out result.json

    # Analyze text from a file
    python hindi_gpt_oss_extractor.py --file input.txt --out result.json
"""
...
nlp = pipeline("ner", model="openai/gpt-oss-20b", tokenizer="openai/gpt-oss-20b")
...
def main():
    parser = argparse.ArgumentParser(description="Hindi Text -> Structured Extraction via GPT-OSS-20B")
