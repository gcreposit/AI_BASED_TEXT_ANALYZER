    ...
    def save_analyzed_data(self, post_id: int, api_response: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            analyzed_data = AnalyzedData(
                ...
                boost_reasons=json.dumps(api_response.get('boost_reasons', [])),
                timestamp=api_response.get('timestamp'),
                
                # Extracted entities
                person_names=json.dumps(entities.get('person_names', [])),
                organisation_names=json.dumps(entities.get('organisation_names', [])),
                location_names=json.dumps(entities.get('location_names', [])),
                district_names=json.dumps(entities.get('district_names', [])),
                thana_names=json.dumps(entities.get('thana_names', [])),
                incidents=json.dumps(entities.get('incidents', [])),
                caste_names=json.dumps(entities.get('caste_names', [])),
                religion_names=json.dumps(entities.get('religion_names', [])),
                hashtags=json.dumps(entities.get('hashtags', [])),
                mention_ids_extracted=json.dumps(entities.get('mention_ids', [])),
                events=json.dumps(entities.get('events', [])),
